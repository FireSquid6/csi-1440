...
public:
   ...
   * setItemId
   *
   * This function stores an integer representation of a cstring into the itemId
   * data member of the ItemInfo class.
   *
   * Parameters:
   ...
   * setDescription
   *
   * This function stores a copy of the passed cstring into the description data
   ...
   * setManCost
   *
   * This function stores an double representation of a cstring into the manCost
   * data member of the ItemInfo class.
   *
   * Parameters:
   ...
   * setSellPrice
   *
   * This function stores an double representation of a cstring into the
   * sellPrice data member of the ItemInfo class.
   *
   * Parameters:
   *      num:  a cstring representation of an double value
   *
   ...
   * getItemId
   *
   * This function returns a copy of the value stored in the itemId data memeber
   ...
   * getDescription
   *
   * This function returns a const reference to the description data member of
   * the ItemInfo class.
   *
   * Parameters: none
   *
   ...
   * getManCost
   *
   * This function returns a copy of the value stored in the manCost data
   * memeber of the ItemInfo class.
   *
   * Parameters: none
   *
   * Output:
   ...
   * getSellPrice
   *
   * This function returns a copy of the value stored in the sellPrice data
   * memeber of the ItemInfo class.
   *
   * Parameters: none
   *
   ...
   * toAmazonJSON
   *
   * This function outputs the data members of the ItemInfo class in a JSON
   * formate specified by Amazon.
   *
   * Parameters:
   ...
   * displayItemInfo
   *
   * This function outputs the data members of the ItemInfo class in a formate
   * specified by Prof. Aars.
   *
   * Parameters:
   ...
   * calcProfit
   *
   * This function computes the difference beteween an ItemInfo's manCost and
   * sellPrice data memebers.
   *
   * Parameters: none
   *
   * Output:
 ...
 * stuCstrToDbl
 *
 * This function converts a cstring representation of a double into a double
 * value
 *
 * Parameters:
 ...
 *
 * Output:
 *      return: a double value that reflects the ascii representation found in
 * num reference parameters: none stream: none
 */
 ...
 * stuDblToCstr
 *
 * This function converts a double value into a cstring representation of a
 * double
 *
 * Parameters:
 *      cstr: the char array holding enough space to store a ascii
 * representation of num num: the double value that is converted into an ascii
 * representation
 *
 * Output:
 *      return: none
 ...
 *
 * Parameters:
 *      dest: the char array that hold a copy of the contents of src.  dest must
 * have enough space to store the copy src: the cstring to be copied
 *
 * Output:
 *      return: none
